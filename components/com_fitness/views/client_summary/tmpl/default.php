...
<div style="opacity: 1;" class="fitness_wrapper">
    ...
    <div id="header_wrapper" style="padding:2px;" ></div>
...
<script src="<?php echo JURI::root(); ?>administrator/components/com_fitness/assets/js/main_client_summary_frontend.js" type="text/javascript"></script>
