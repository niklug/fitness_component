                                                        ...
                                                        <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                                                            <tr>
                                                                <td colspan="2" style="margin:0; padding:15px 0 0 0; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#CCC;"><p>Hi <?php echo $data->client_name;?>,<br />
                                                                        <br />
                                                                        Your trainer '<?php echo $data->trainer_name ;?>' has reviewed and finalised your recent <?php echo $data->item->title;?> and provided feedback and comments for you to review. The assessment details are as follows...</p></td>
                                                            </tr>
                                                            <tr>
