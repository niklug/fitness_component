                                                        ...
                                                        <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                                                            <tr>
                                                                <td style="margin:0; padding:0 0 15px 0;">
                                                                    <h1 style="padding:0; margin:0; font-family:Arial, Helvetica, sans-serif; font-size:30px; line-height:33pt; color:#FFF; font-weight:lighter; margin-bottom:0 !important;">ASSESSMENT SUMMARY!</h1>	
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                                                            <tr>
                                                                <td colspan="2" style="margin:0; padding:15px 0 0 0; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#CCC;"><p>Hi <?php echo $client_name;?>,<br />
                                                                        <br />
                                                                        Your trainer '<?php echo $trainer_name;?>' has reviewed and finalised your recent <?php echo $event_data->title;?> and provided feedback and comments for you to review. The assessment details are as follows...</p></td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td width="71%" style="margin:0; padding:15px 0 0 0; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#CCC;">
                                                                    <p><?php echo $start_date;?><br />
                                                                        ...
                                                                        <?php echo $event_data->location;?> </p></td>
                                                            </tr>
                                                            <tr>
                                                                <td style="margin:0; padding:15px 0 0 0; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#CCC;">APPOINTMENT:<br />
                                                                    SESSION TYPE:<br />
                                                                    SESSION FOCUS:</td>
                                                                <td style="margin:0; padding:15px 0 0 0; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#CCC;"><?php echo $event_data->title;?><br />
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="margin:0; padding:15px 0 20px 0; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#CCC;"><?php echo $trainer_name;?></td>
                                                            </tr>
                                                        </table>
                                                        <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                                                            <tr>
                                            ...
                                            <table width="580" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                                                <tr>
                                                    ...
                                                    <td valign="top" style="padding:10px 0 0 20px; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#482104;">
                                                        <p>Your next assessment will be scheduled by your trainer and should be discussed at your next consultation.</p>
                                                        <p>If you are a BioSignature client, your assessment schedule should already be programmed into your Online VIP Client Calendar! </p>
                                                        <p>Please remember, If you are scheduled for an assessment,  DO NOT perform a warm up or take part in any physical activity prior to your appointment. Doing so will result with inaccurate measurements and readings being taken!</p></td>
                                                </tr>
