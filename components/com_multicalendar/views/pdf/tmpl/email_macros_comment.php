...
<?php
        ...
        // 
        $params = array('method' => 'NutritionPlan', 'id' => $id, 'layout' => $layout, 'comment_id' => $comment_id);
                                            ...
                                            <table width="364" cellpadding="0" cellspacing="0" style="width: 580px;">
                                                <tr>
                                                    <td width="100%" style="padding:0 20px 0 0;" valign="top">
                                                        ...
                                                        <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                                                            <tr>
                                                                <td colspan="2" style="margin:0; padding:15px 0 15px 0; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#CCC;"><p>Additional comments or instructions have been posted about your nutrition plan. Please take a moment to review, take into account and action any requests or instructions.</p></td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="margin:0; padding:15px 0 15px 0; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#CCC;">
                                                                    <?php echo $data->item->mini_goal_name ?> <br />
                                                                    <?php echo $data->item->training_period_name ?><br />
                                                                    <?php echo $data->mini_goal_start_date ?><br />
                                                                    <?php echo $data->mini_goal_deadline ?></td>
                                                            </tr>
                                                            <tr>
                                                                <td style="margin:0; padding:15px 0 15px 0; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#CCC;">
                                                                    NUTRITION FOCUS:<br />
