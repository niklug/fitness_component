    ...
    <head>
        ...
        <style type="text/css">
            ...
            .darkContainer a:hover {
                color:#e76708 !important;
            }
            .readMore a:hover {
                background-color:#322001 !important;
                color: #e76708 !important;
            }
            body {
                margin:0;
...
$sitelink = JURI::root() .'index.php?option=com_multicalendar&view=pdf&layout=' . $layout . '&tpml=component&id=' . $id . '&goal_type=' . $goal_type . '&comment_id=' . $comment_id;

$comment = getGoalCommentData($comment_id, $goal_type);

$date = JFactory::getDate($comment->created);
$comment_date =  $date->toFormat('%A, %d %b %Y') ;
$comment_time =  $date->format('H:i');
$user = &JFactory::getUser($comment->created_by);
$comment_created_by = $user->name;
...
?>
        <table width="100%" cellpadding="0" cellspacing="0">
                                            ...
                                            <table width="364" cellpadding="0" cellspacing="0" style="width: 580px;">
                                                <tr>
                                                    <td width="100%" style="padding:0 20px 0 0;" valign="top">
                                                        ...
                                                        <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                                                            <tr>
                                                                <td colspan="2" style="margin:0; padding:15px 0 15px 0; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#CCC;"><p>Additional comments, feedback or instructions have  been posted about this goal. Please review and reply by clicking the link below:</p></td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td width="29%" style="margin:0; padding:15px 0 15px 0; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#CCC;">COMMENT BY: <br />
                                                                    DATE / TIME:</td>
                                                                <td width="71%" style="margin:0; padding:15px 0 15px 0; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#CCC;"><?php echo $comment_created_by;?> <br />
                                                                    <?php echo $comment_date . ' ' . $comment_time;?></td>
                                                            </tr>
                                                            <tr>
                                                                <td style="margin:0; padding:15px 0 15px 0; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#CCC;">COMMENT: </td>
                                                                <td style="margin:0; padding:15px 0 15px 0; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#CCC;"><?php echo $comment->comment;?> </td>
                                                            </tr>
                                                        </table>
                                                        <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                                                            <tr>
                                                                <td class="readMore" width="160" height="22" bgcolor="#241002" valign="middle" style="padding:0px; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:100%; color:#F00; text-align:center;">
                                                                    <a href="#" style="display:block; text-decoration:none; height:22px; line-height:22px; color:#e76708;">CLICK HERE TO OPEN</a>
                                                                </td>
                                                                <td width="396">&nbsp;</td>
                                                            </tr>
                                                        </table>
            ...
            <tr>
                <td bgcolor="#dddddd" style="padding:20px 0">&nbsp;</td>
            </tr>
        </table>
    </body>
</html>
