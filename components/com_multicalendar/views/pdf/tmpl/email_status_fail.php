...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        ...
        <style type="text/css">
            ...
            .readMore a:hover {
                background-color:#5C030C !important;
                color: #FFF !important;
            }
            body {
                margin:0;
                                                        ...
                                                        <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                                                            <tr>
                                                                <td style="margin:0; padding:0 0 15px 0;">
                                                                    <h1 style="padding:0; margin:0; font-family:Arial, Helvetica, sans-serif; font-size:30px; line-height:33pt; color:#FFF; font-weight:lighter; margin-bottom:0 !important;">ASSESSMENT UNSATISFACTORY!</h1>	
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                                                        ...
                                                        <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                                                            <tr>
                                                                <td class="readMore" width="160" height="22" bgcolor="#1B1B1B" valign="middle" style="padding:0px; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:100%; color:; text-align:center;">
                                                                    <a target="_blank" href="<?php echo $data->open_link; ?>" style="display:block; text-decoration:none; height:22px; line-height:22px; color:#790010;">CLICK HERE TO OPEN</a>
                                                                </td>
                                                                <td width="396">&nbsp;</td>
                                                            </tr>
                                                        </table>
