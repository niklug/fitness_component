                                                        ...
                                                        <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                                                            <tr>
                                                                <td colspan="2" style="margin:0; padding:15px 0 15px 0; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#FFF;"><p>Hi <?php echo $data->client_name;?>,<br />
                                                                        <br />
                                                                        Well done on another session successfully completed. Your continual commitment to your training, health and fitness WILL deliver the results you envisioned, so keep up the great work!</p>
                                                                    <p>If you have just completed an assessment, your data will be evaluated and the results made available for you to view online as soon as possible.</p></td>
                                                            </tr>
                                                            <tr>
