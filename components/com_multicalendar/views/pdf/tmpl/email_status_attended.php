                        ...
                        <tr>
                            <td bgcolor="#ffffff" style="padding:5px; border:1px #aaaaaa solid;">
                                                        ...
                                                        <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                                                            <tr>
                                                                <td colspan="2" style="margin:0; padding:15px 0 15px 0; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#FFF;"><p>Hi <?php echo $data->client_name;?>,<br />
                                                                        <br />
                                                                        Well done on another successfully completed training session. Your continual commitment to your health and fitness WILL deliver the results you envisioned, so keep up the good work!</p>
                                                                    <p>Be sure to check your online client calendar for any comments and feedback regarding this particular training session or appointment!</p></td>
                                                            </tr>
                                                            <tr>
                                    ...
                                    <tr>
                                        <td bgcolor="#005A00" style="padding:20px;">
                                            ...
                                            <table width="580" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                                                <tr>
                                                    <td  style="padding:15px 0 0 0; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#482104;" valign="top" rowspan="2">
                                ...
                                <table class="lightContainer" width="620" align="center" cellpadding="0" cellspacing="0" style="border-collapse:#810109; margin:0 auto; text-align:left;">
                                    <tr>
                                        <td bgcolor="#005A00" valign="top" style="padding:10px 0 0 20px; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#CCC;">
