...
$nutrition_plan = getNutritionPlanData($nutrition_plan_id);


$date = JFactory::getDate($nutrition_plan->active_start);
$start_date =  $date->toFormat('%A, %d %b %Y') . ' ' . $date->format('H:i');

$client_name = &JFactory::getUser($nutrition_plan->client_id)->name;

$trainer_name = &JFactory::getUser($nutrition_plan->trainer_id)->name;

$path = JUri::base() . 'components/com_multicalendar/views/pdf/tmpl/images/';
$sitelink = JUri::base() . 'index.php?option=com_multicalendar&view=pdf&layout=email_notify_nutrition_plan&tpml=component&nutrition_plan_id=' . $nutrition_plan_id;
?>
                                                        ...
                                                        <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                                                            <tr>
                                                                <td style="margin:0; padding:0 0 15px 0;">
                                                                    <h1 style="padding:0; margin:0; font-family:Arial, Helvetica, sans-serif; font-size:30px; line-height:33pt; color:#FFF; font-weight:lighter; margin-bottom:0 !important;"> YOUR NUTRITION PLAN IS READY!</h1>	
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                                                            <tr>
                                                                <td colspan="2" style="margin:0; padding:15px 0 15px 0; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#CCC;"><p>Hi <?php echo $client_name;?>,</p>
                                                                    <p>Your new customized Nutrition Plan is now available for you to view!</p>
                                                                    <p>This Nutrition Plan has been created by your trainer and is specific to your current training phase and fitness goal. Please be sure to review every detail and ask any questions you may have about this nutrition phase.</p>
                                                                    <p>Your Nutrition Diary entries should now reflect the changes made in this nutrition phase as your  diary entries will now be scored based on your new and current nutrition plan.</p></td>
                                                            </tr>
                                                            <tr>
                                                                <td width="29%" style="margin:0; padding:15px 0 15px 0; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#CCC;">NUTRITION FOCUS: <br />
                                                                    PRIMARY GOAL: <br />
                                                                    START DATE: <br />
                                                                    CREATED BY: </td>
                                                                <td width="71%" style="margin:0; padding:15px 0 15px 0; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#CCC;"><?php echo $nutrition_plan->nutrition_focus ?><br />
                                                                    <?php echo $nutrition_plan->primary_goal ?> <br />
                                                                    <?php echo $start_date ?><br />
                                                                    <?php echo $trainer_name ?></td>
                                                            </tr>
                                                        </table>
                                                        <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                                                            <tr>
