...
$sitelink = JUri::base() . 'index.php?option=com_multicalendar&view=pdf&layout=email_status_no_show&tpml=component&event_id=' . $event_id . '&client_id=' . $client_id;
?>
                                                        ...
                                                        <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                                                            <tr>
                                                                <td colspan="2" style="margin:0; padding:15px 0 15px 0; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#FFF;"><p>Hi <?php echo $client_name;?>,<br />
                                                                        <br />
                                                                        You did not show up for your scheduled appointment. Please review the Elite Fitness Terms and Conditions stated below in this email.</p></td>
                                                            </tr>
                                                            <tr>
