                                                        ...
                                                        <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                                                            <tr>
                                                                <td colspan="2" style="margin:0; padding:15px 0 15px 0; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#FFF;"><p>Hi <?php echo $data->client_name;?>,<br />
                                                                        <br />
                                                                        Your appointment has been cancelled. Please contact your Trainer to schedule a new appointment, or you may schedule your own availabilities via your online client calendar!</p></td>
                                                            </tr>
                                                            <tr>
