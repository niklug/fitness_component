 ...
 */
class FitnessControllerNutrition_diary extends FitnessController
{
	...
	public function edit()
	{
		...
		// Get the model.
		$model = $this->getModel('Nutrition_diary', 'FitnessModel');
		...
		$this->setRedirect(JRoute::_('index.php?option=com_fitness&view=nutrition_diaryform&layout=edit', false));
	}
