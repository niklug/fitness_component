...
<script type="text/javascript">
   Joomla.submitbutton = function(task)
            {
                if (task == 'settings_force_type.cancel') {
                    Joomla.submitform(task, document.getElementById('settings_force_type-form'));
                }
                else{
                    
                    if (task != 'settings_force_type.cancel' && document.formvalidator.isValid(document.id('settings_force_type-form'))) {
