...
<script type="text/javascript">
    ...
    var options = {
        ...
        'db_table_exercises': '#__fitness_pr_temp_exercises',
...
<script src="<?php echo JURI::root(); ?>administrator/components/com_fitness/assets/js/main_programs_templates.js" type="text/javascript"></script>
