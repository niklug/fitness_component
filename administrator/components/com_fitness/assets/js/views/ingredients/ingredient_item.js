define([
	...
	'backbone',
        'app',
        'collections/ingredients/nutrition_database_ingredients',
        'views/ingredients/search_results',
    ...
    var view = Backbone.View.extend({
            ...
            populateSearchContainer : function(collection, search_text) {
                ...
                var collection = new this.options.recipe_ingredients_collection(all_models);

                var sorted_collection = _.sortBy(collection.models, function(model){ return  parseInt(model.get('position')); });
                
                collection = new this.options.recipe_ingredients_collection(sorted_collection);
