define([
	...
	'backbone',
        ...
        'views/assessments/frontend/photo_block/item',
	'text!templates/assessments/frontend/photo_block/list.html'
    ...
    var view = Backbone.View.extend({
        ...
        addItem : function(model) {
             this.container_el.append(new Item_view({model : model, readonly : this.options.readonly }).render().el); 
        },
