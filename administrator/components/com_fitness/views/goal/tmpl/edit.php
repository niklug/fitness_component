...
<?php echo $this->form->getLabel('user_id'); ?>
                ...
                <li>
                    <?php echo $this->form->getLabel('goal_category_id'); ?>
                
                    <?php
                    echo $helper->generateSelect($helper->getPrimaryGoalCategory(), 'jform[goal_category_id]', 'jform_goal_category_id', $this->item->goal_category_id, '', true, "required");
                    ?>
                </li>
