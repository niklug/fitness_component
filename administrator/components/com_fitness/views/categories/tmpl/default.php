...
<form action="<?php echo JRoute::_('index.php?option=com_fitness&view=categories'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_FITNESS_CATEGORIES_NAME', 'a.name', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_FITNESS_CATEGORIES_COLOR', 'a.color', $listDirn, $listOrder); ?>
				</th>
		...
		<?php foreach ($this->items as $i => $item) :
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<?php if ($canEdit AND FitnessHelper::is_superuser(JFactory::getUser()->id)) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_fitness&task=category.edit&id='.(int) $item->id); ?>">
