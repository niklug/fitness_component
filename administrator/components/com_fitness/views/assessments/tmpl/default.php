    ...
    var options = {
       ...
       //event client status options
        ...
        'statuses' : {
            ...
            '9' : {'label' : 'ATTENDED',        'class' : 'status_pass',                'email_alias' : 'AppointmentAttended'},
            '10': {'label' : 'CANCELLED',       'class' : 'event_status_cancelled',     'email_alias' : 'AppointmentCancelled'},
            '11': {'label' : 'LATE CANCEL',     'class' : 'status_fail',                'email_alias' : 'AppointmentLatecancel'},
            '12': {'label' : 'NO SHOW',         'class' : 'status_fail',                'email_alias' : 'AppointmentNoshow'}, 
